...
void CUIDesignerView::Notify(TNotifyUI& msg)
{
	...
	else if(msg.nType==DUI_MSGTYPE_FORMSIZE)
	{
		if(GetControlType(pControl)!=typeForm)
			return;
		CWindowUI* pForm=m_LayoutManager.GetForm();
